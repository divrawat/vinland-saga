...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Enjoy reading ${MANGA_NAME} chapter ${chapterNumber} online at ${DOMAIN}. It follows Thorfinn, a young Viking warrior, on his journey for revenge and discovery in medieval Europe. The story blends historical drama with intense action and rich character development.`
